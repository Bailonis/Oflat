...
They are already in an advanced stage of development, thanks to the work of several students and professors.

The OCamlFLAT library consists of various modules that make up the logical part of the system, where several FLAT theory models have already been implemented. The OFLAT platform, on the other hand, is a web application that provides a pedagogical graphical interface.
...
Entity: This module represents the most abstract level of the library. The entities are the exercises and the FLAT models.

Exercise: This module is responsible for supporting exercises, which are validated using unit tests extending the Entity module.
...
PushdownAutomaton: This module contains the functionalities of a pushdown automaton.
