...
the left-hand side target, within the context of the same rule. A depth-first search detects any cycle; if present, validation fails with 
\enquote{Attribute dependency cycle detected}. This prevents unschedulable attribute computations at evaluation time. 
...
this fuction constructs the dependency graph of the whole grammar and return it as adjacency lists. 
...
This fuction decides if the directed graph contains any cycle using DFS with a recursion stack. 
