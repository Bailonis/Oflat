...
\begin{flushleft}
    \begin{ganttchart}[hgrid,vgrid]{1}{24}
        \gantttitle{Work Plan Timeline (Weeks)}{24} \\
        \gantttitlelist{1,...,24}{1} \\
        \ganttbar{OCamlFLAT Library}{1}{8} \\
        \ganttbar{OFLAT Web Application}{9}{14} \\
        \ganttbar{Pedagogical Exercises}{15}{15} \\
        \ganttbar{Evaluation}{16}{16} \\
        \ganttbar{Dissertation Writing}{17}{24}
    \end{ganttchart}
\end{flushleft}