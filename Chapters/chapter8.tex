...
their correct functioning. Especially on tests for the word acceptance operation, since it is complex and highly visible and calculating attributes, since 
...
that represent the history of a derivation or evaluation; these trees are consumed by the graphical tool to perform its main visualization of the 
evaluation process.
