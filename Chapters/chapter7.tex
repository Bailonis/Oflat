...
\subsection{\texttt{ag2}}
\textbf{Inherited:} \texttt{["d"]}\quad
\textbf{Synthesized:} \texttt{["v","r"]}
...
\subsection{\texttt{ag4}}
\textbf{Inherited:} \texttt{[""]}\quad
\textbf{Synthesized:} \texttt{["b"]}
...
\subsection{\texttt{ag\_expr\_ext}}
\textbf{Inherited:} \texttt{[""]}\quad
\textbf{Synthesized:} \texttt{["v","s","h"]}
