...
\begin{tikzpicture}[
  ...
  level 3/.style={sibling distance=24mm, level distance=20mm},
...
\begin{tikzpicture}[
  ...
  level 3/.style={sibling distance=32mm, level distance=20mm},
  level 4/.style={sibling distance=26mm, level distance=20mm},
  edge from parent/.style={draw, -latex},
  every node/.style={draw, ellipse, align=center}
]
\node {L\\$v=4$}
